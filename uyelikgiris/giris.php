    ...
    if(isset($_POST['giris']))
{
  ...
  {
    $kullanicisorgu=$db->prepare('SELECT * FROM kullanicilar_tablo WHERE kullanici_adi=? || kullanici_sifre=?');
            ...
            <div class="card p-5">
                ...
                <H3>Üye Giriş Sistemi</H3><br>
                    ...
                    <form action="giris.php" method="POST">
                        ...
                        <button type="submit"  name="git" ><a href="kayit.php">Kayıt Ol</a></button>
                        <button type="submit"  name="git" ><a href="admingiris.php">Admin Giriş</a></button>
                    </form>
